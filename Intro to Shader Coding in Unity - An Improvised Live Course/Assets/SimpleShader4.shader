Shader "Custom/SimpleShader4"
{
    // Shade from actual light source in game scene.
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (VertexOutput o) : SV_Target
            {
                ...
                float3 lightColor = _LightColor0; // https://docs.unity3d.com/Manual/SL-UnityShaderVariables.html
